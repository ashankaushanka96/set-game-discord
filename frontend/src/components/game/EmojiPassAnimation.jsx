...
export default function EmojiPassAnimation() {
  ...
  useEffect(() => {
    const updateSeatPositions = () => {
      ...
      seats.forEach(seat => {
        ...
        const root = overlayRef.current ? overlayRef.current.getBoundingClientRect() : { left: 0, top: 0 };
  ...
  return (
    <div ref={overlayRef} className="fixed inset-0 pointer-events-none z-[110]">
      {/* Flying Emojis */}
